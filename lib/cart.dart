...
class BottomBar extends StatelessWidget {
  ...
  GestureDetector nextButtonBar(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => CarsList()));
      },
      child: Container(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            flex: 1,
            child:  foodItems.length > 0 ? foodItemList() : noItemList(),
          )
        ],
      ),
    );
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              Text("Order", style: TextStyle(fontWeight: FontWeight.w300, fontSize: 35),),
            ],
          )
        ],
      ),
